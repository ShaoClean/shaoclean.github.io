...
<h2 id="vue-config-js-配置文件" tabindex="-1"><a class="header-anchor" href="#vue-config-js-配置文件" aria-hidden="true">#</a> vue.config.js 配置文件</h2>
<p>使用 vue inspect &gt; output.js 可以查看到 Vue 脚手架的默认配置</p>
<p>使用 vue.config.js 可以对脚手架进行个性化定制</p>
<p>详情见:https://cli.vue.js.org/zh</p>
<h2 id="ref-属性" tabindex="-1"><a class="header-anchor" href="#ref-属性" aria-hidden="true">#</a> ref 属性</h2>
<p>1.被用来给元素或子组件注册引用信息（id 的替代者）</p>
<p>2.应用在 html 标签上获取的是真实 DOM 元素，应用在组件标签上是组件实例对象（vc）</p>
<p>3.使用方法</p>
<p>a.先打标识：<code v-pre>&lt;h1 ref=&quot;XXX&quot;&gt;...&lt;/h1&gt;</code> 或 <code v-pre>&lt;School ref=&quot;XXX&quot;&gt;&lt;/School&gt;</code></p>
<p>b.随后通过<code v-pre>this.$refs.xxx</code>获取 dom 元素</p>
<h2 id="配置项-props" tabindex="-1"><a class="header-anchor" href="#配置项-props" aria-hidden="true">#</a> 配置项 props</h2>
...
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code>export default{ props:['name'] }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>第二种方式(限制类型)：</li>
</ul>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code>export default{ props:{ name:Number } }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>第三种方式（限制类型、限制必要性、制定默认值）：</li>
</ul>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code>export default{ props:{ name:{ type:String,//类型 require:true,//必要性
default:'老王'//默认值 } } }
...
<p>1.props 是只读的，Vue 底层会监测你对 props 的修改，如果进行了修改，就会发出警告，
若业务需求需要修改，请复制一份到 data 中，换一个名字，然后写成 this.XXX 的形式。</p>
<p>2.本身 data 中不存在数据，即通过 props 传递过来的数据，最好不要修改，控制台会报错，</p>
<p>3.如果同时存在，会优先显示 props 中的数据 （props 中的数据是优先被接受的，是优先被放在 VC 上的）
所以可以在 data 中写 myAge:this.age，这样就能实现修改传递过来的数据不报错的情况</p>
</div>
</li>
</ul>
...
使用插件：Vue.install
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结-todolist-案例" tabindex="-1"><a class="header-anchor" href="#总结-todolist-案例" aria-hidden="true">#</a> 总结 ToDoList 案例</h2>
...
<p>1.存储内容大小一般支持 5MB 左右（不同浏览器可能还不一样）</p>
<p>2.浏览器端通过 Windows.sessionStorage 和 Windows.localStorage 属性来实现本地存储机制。</p>
<p>3.相关 API：</p>
...
<p>​ 该方法会清空存储中的所有数据</p>
<p>4.备注：</p>
<p>​ 1.SessionStorage 存储的内容会随着浏览器串口关闭而消失</p>
<p>​ 2.LocalStorage 存储的内容，需要手动清除才会消失</p>
<p>​ 3.<code v-pre>xxxxStorage.getItem(xxx);</code>如果 xxx 对应的 value 获取不到，那么 getitem 的返回值是 null</p>
<p>​ 4.<code v-pre>JSON.parse(null)</code>的结果依然是 null</p>
<h2 id="组件的自定义事件" tabindex="-1"><a class="header-anchor" href="#组件的自定义事件" aria-hidden="true">#</a> 组件的自定义事件</h2>
<p>1.一种组件间通信的方式，适用于：子组件==》父组件</p>
<p>2.使用场景：A 是父组件，B 是子组件，B 想给 A 传数据，那么就要在 A 中给 B 绑定自定义事件<code v-pre>（事件的回调在A中）</code></p>
<p>3.绑定自定义事件：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 3.若想让事件只触发一次，可以使用 once 修饰符，或者$once 方法</p>
<p>4.触发自定义事件：<code v-pre>this.$emit('clean',需要传递的参数)</code></p>
<p>5.解绑自定义事件：<code v-pre>this.$off('clean')</code></p>
<p>6.组件上也可以绑定原生 DOM 事件，需要使用<code v-pre>.native</code>修饰符</p>
<p>7.注意：通过<code v-pre>this.$refs.$emit.('clean',回调)</code>绑定自定义事件时，回调要么配置在 methods 中,要么用箭头函数，否则 this 指向会出现问题</p>
...
<p>​ 1.接收数据：A 组件想要接收数据，则在 A 组件中给$bus 绑定自定义事件，事件的回调留在 A 组件自身</p>
...
<p>4.最好在 beforeDestroy 钩子中,用$off 去解绑当前组件所用到的时间</p>
...
<p>2.使用步骤：</p>
<p>​ 1.安装 pubsub:<code v-pre>npm i pubsub-js</code></p>
<p>​ 2.引入：<code v-pre>import pubsub from 'pubsub-js'</code></p>
<p>​ 3.接受数据：A 组件想接受数据，则在 A 组件中订阅消息，订阅的回调留在 A 组件自身</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>	<span class="token function">methods</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<p>​ 5.最好在 beforeDestroy 钩子中，用<code v-pre>pubsub.unsubscribe(this.pubId)</code>去<span style='color:red'>取消订阅</span></p>
...
<p>2.作用：在下一次 DOM 更新结束后执行其指定的回调</p>
<p>3.什么时候用：当改变数据后，要基于更新后的新 DOM 进行某些操作时，要在 nextTick 所指定的回调函数中执行</p>
<h2 id="vue-封装的过渡与动画" tabindex="-1"><a class="header-anchor" href="#vue-封装的过渡与动画" aria-hidden="true">#</a> Vue 封装的过渡与动画</h2>
<p>1.作用:在插入、更新或移除 DOM 元素时,在合适的时候给元素添加样式类名</p>
<p>2.图示:</p>
...
<p>​ 2.使用<code v-pre>&lt;transition&gt;</code>包裹过渡的元素,并配置 name 属性:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 3.备注:若有多个元素需要过渡,则需要使用<code v-pre>&lt;transition-group&gt;</code>，且每个元素都要指定 key 值,例如<code v-pre>:key=&quot;1&quot;</code></p>
<h2 id="vue-脚手架配置代理" tabindex="-1"><a class="header-anchor" href="#vue-脚手架配置代理" aria-hidden="true">#</a> Vue 脚手架配置代理</h2>
...
<p>1.作用：让父组件可以向子组件指定位置插入 html 结构，也是一种组件间通信的方式，适用于父组件====》子组件(组件的使用者)</p>
...
<p>​ 在 vue 中实现集中式状态（数据）管理的一个 vue 插件，对 vue 应用中多个组件的共享状态进行集中式管理（读/写），也是一种组件间的通信方式，且适用于任意组件之间的通信</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 2.在<code v-pre>main.js</code>中创建 vm 时传入<code v-pre>store</code>配置项</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 2.组件中读取 vuex 的数据：<code v-pre>this.$store.state.sum</code></p>
<p>​ 3.组件中修改 vuex 的数据：<code v-pre>this.$store.dispatch('actions中的方法名',需要传递的数据)</code>或<code v-pre>this.$store.commit('mutations中的方法名，需要传递的数据')</code></p>
<p>​ <strong>备注：</strong></p>
<p>​ 若没有网络请求或其他的业务逻辑，组件也可以越过 actions，不用写 dispatch，直接编写 commit</p>
<p><strong>5.getters 属性</strong></p>
<p>​ 1.概念：当 state 中的数据需要加工后再使用时，可以使用 getters 加工</p>
...
<p><strong>6.四个 map 方法的使用</strong></p>
...
<p>​ mapActions 与 mapMutations 在传递数据时，需要在模板中调用方法是写好要传递的参数，否则传递的是事件对象</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 3.开启命名空间后，组件读取 state 中的数据：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 4.开启命名空间后，组件读取 getters 中的数据：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>//方式一：直接自己读取
this.$store.getters['personAbout/firstPersonName']
//方式二：借助mapGetters读取
...mapGetters{'countAbout',['bigSum']}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 5.开启命名空间后，组件调用 dispatch：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 6.开启命名空间后，组件调用 commit：</p>
...
<p>​ 1.安装 vue-router，命令：<code v-pre>npm i vue-router</code></p>
<p>​ 2.应用插件：<code v-pre>Vue.use(VueRouter)</code></p>
<p>​ 3.编写 router 配置项（创建 router 文件夹并在该文件夹下创建 index.js 文件）</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 4.实现切换（active-class 可实现展示当前组件时的样式）</p>
...
<p>​ 3.整个应用只有一个 router，可以通过组件的<code v-pre>$router</code>属性获取到</p>
<p><strong>3.多极路由</strong></p>
<p>​ 1.配置规则，使用 children 配置项</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>//该文件专门用于创建整个应用的路由器
import VueRouter from "vue-router";
//引入组件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>4.路由的 query 参数</strong></p>
<p>​ 1.传递参数</p>
...
&lt;router-link :to="{
          ...
          message002
&lt;/router-link>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>6.路由的 params 参数</strong></p>
<p>​ 1.配置路由，声明接受 params 参数</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code> {
      path:'/home',
      component:Home,
      children:[
...
<p>​ 路由携带 params 参数是，若使用 to 的对象写法，则不能使用 path 配置项，必须使用 name 配置</p>
<p>​ 3.接收参数</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>$route.params.id
$route.params.title
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>7.路由的 props 配置</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>8.<code v-pre>&lt;router-link&gt;</code>的 replace 属性</strong></p>
<p>​ 1.作用：控制路由跳转时操作浏览器历史记录的模式（默认是 push 模式，可以后退）</p>
<p>​ 2.浏览器的历史记录有两种写入方式：分别为<code v-pre>push</code>和<code v-pre>replace</code>，push 是追加历史记录，replace 是替换当前记录。路由跳转时候默认为 push</p>
<p>​ 3.开启 replace 模式</p>
...
<p>​ 2.hash 值不会包括在 HTTP 请求中，即 hash 值不会带给服务器</p>
<p>​ 3.hash 模式：</p>
<p>​ 1.地址中永远带着#号，不美观</p>
...
<p>​ 3.应用部署上线时需要后端人员支持，解决刷新页面服务端 404 的问题</p>
</div></template>
