<template><div><h1 id="reactcli" tabindex="-1"><a class="header-anchor" href="#reactcli" aria-hidden="true">#</a> ReactCli</h1>
<h2 id="一、todolist案例相关知识点" tabindex="-1"><a class="header-anchor" href="#一、todolist案例相关知识点" aria-hidden="true">#</a> 一、todoList案例相关知识点</h2>
...
<h2 id="二、github搜索案例相关知识点" tabindex="-1"><a class="header-anchor" href="#二、github搜索案例相关知识点" aria-hidden="true">#</a> 二、github搜索案例相关知识点</h2>
...
<h2 id="三、路由的基本使用" tabindex="-1"><a class="header-anchor" href="#三、路由的基本使用" aria-hidden="true">#</a> 三、路由的基本使用</h2>
<p>1.明确好界面中的导航区、展示区
2.导航区的a标签改为Link标签
<code v-pre>&lt;Link to=&quot;/xxxxx&quot;&gt;Demo&lt;/Link&gt;</code>
3.展示区写Route标签进行路径的匹配
<code v-pre>&lt;Route path='/xxxx' component={Demo}/&gt;</code>
4.<code v-pre>&lt;App&gt;</code>的最外侧包裹了一个<code v-pre>&lt;BrowserRouter&gt;或&lt;HashRouter&gt;</code></p>
<h2 id="四、路由组件与一般组件" tabindex="-1"><a class="header-anchor" href="#四、路由组件与一般组件" aria-hidden="true">#</a> 四、路由组件与一般组件</h2>
<p>1.写法不同：
一般组件：<code v-pre>&lt;Demo/&gt;</code>
路由组件：<code v-pre>&lt;Route path=&quot;/demo&quot; component={Demo}/&gt;</code>
2.存放位置不同：
一般组件：components
路由组件：pages
3.接收到的props不同：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、navlink与封装navlink" tabindex="-1"><a class="header-anchor" href="#五、navlink与封装navlink" aria-hidden="true">#</a> 五、NavLink与封装NavLink</h2>
<pre><code>			1.NavLink可以实现路由链接的高亮，通过activeClassName指定样式名
</code></pre>
<h2 id="六、switch的使用" tabindex="-1"><a class="header-anchor" href="#六、switch的使用" aria-hidden="true">#</a> 六、Switch的使用</h2>
<pre><code>			1.通常情况下，path和component是一一对应的关系。
			2.Switch可以提高路由匹配效率(单一匹配)。
</code></pre>
<h2 id="七、解决多级路径刷新页面样式丢失的问题" tabindex="-1"><a class="header-anchor" href="#七、解决多级路径刷新页面样式丢失的问题" aria-hidden="true">#</a> 七、解决多级路径刷新页面样式丢失的问题</h2>
<pre><code>			1.public/index.html 中 引入样式时不写 ./ 写 / （常用）
			2.public/index.html 中 引入样式时不写 ./ 写 %PUBLIC_URL% （常用）
			3.使用HashRouter
</code></pre>
<h2 id="八、路由的严格匹配与模糊匹配" tabindex="-1"><a class="header-anchor" href="#八、路由的严格匹配与模糊匹配" aria-hidden="true">#</a> 八、路由的严格匹配与模糊匹配</h2>
<pre><code>			1.默认使用的是模糊匹配（简单记：【输入的路径】必须包含要【匹配的路径】，且顺序要一致）
			2.开启严格匹配：&lt;Route exact={true} path=&quot;/about&quot; component={About}/&gt;
			3.严格匹配不要随便开启，需要再开，有些时候开启会导致无法继续匹配二级路由
</code></pre>
<h2 id="九、redirect的使用" tabindex="-1"><a class="header-anchor" href="#九、redirect的使用" aria-hidden="true">#</a> 九、Redirect的使用</h2>
...
<h2 id="十、嵌套路由" tabindex="-1"><a class="header-anchor" href="#十、嵌套路由" aria-hidden="true">#</a> 十、嵌套路由</h2>
<pre><code>			1.注册子路由时要写上父路由的path值
			2.路由的匹配是按照注册路由的顺序进行的
</code></pre>
<h2 id="十一、向路由组件传递参数" tabindex="-1"><a class="header-anchor" href="#十一、向路由组件传递参数" aria-hidden="true">#</a> 十一、向路由组件传递参数</h2>
<p>1.params参数
路由链接(携带参数)：<code v-pre>&lt;Link to='/demo/test/tom/18'}&gt;详情&lt;/Link&gt;</code>
注册路由(声明接收)：<code v-pre>&lt;Route path=&quot;/demo/test/:name/:age&quot; component={Test}/&gt;</code>
接收参数：this.props.match.params
2.search参数
路由链接(携带参数)：<code v-pre>&lt;Link to='/demo/test?name=tom&amp;age=18'}&gt;详情&lt;/Link&gt;</code>
注册路由(无需声明，正常注册即可)：<code v-pre>&lt;Route path=&quot;/demo/test&quot; component={Test}/&gt;</code>
接收参数：this.props.location.search
备注：获取到的search是urlencoded编码字符串，需要借助qs(import qs from 'qs')解析
3.state参数
路由链接(携带参数)：<code v-pre>&lt;Link to={{pathname:'/demo/test',state:{name:'tom',age:18}}}&gt;详情&lt;/Link&gt;</code>
注册路由(无需声明，正常注册即可)：<code v-pre>&lt;Route path=&quot;/demo/test&quot; component={Test}/&gt;</code>
接收参数：this.props.location.state
备注：刷新也可以保留住参数</p>
<h2 id="十二、编程式路由导航" tabindex="-1"><a class="header-anchor" href="#十二、编程式路由导航" aria-hidden="true">#</a> 十二、编程式路由导航</h2>
...
<p>一般组件身上没有history属性,需要经过withRouter()函数加工，将一般组件变为路由组件。</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>import {withRouter} from 'react-router-dom'
class MyComponent {
	render(){}
	//.....
}
...
<h2 id="十四、antd的按需引入-自定主题" tabindex="-1"><a class="header-anchor" href="#十四、antd的按需引入-自定主题" aria-hidden="true">#</a> 十四、antd的按需引入+自定主题</h2>
