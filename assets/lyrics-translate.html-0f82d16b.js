import{$ as s,a0 as a,a1 as t,a5 as p,a2 as n,a3 as e,a4 as o}from"./framework-19a42cda.js";const c={},i=n("h1",{id:"歌词滚动",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#歌词滚动","aria-hidden":"true"},"#"),e(" 歌词滚动")],-1),l=o(`<p>歌词：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> lyrics <span class="token operator">=</span> <span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">[00:00.00]我落泪情绪零碎
[00:00.100]作词 : 方文山
[00:01.000]作曲 : 周杰伦
[00:02.000]编曲 : 钟兴民
[00:03.000]制作人 : 周杰伦
