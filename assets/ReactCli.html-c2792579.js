import{$ as t,a0 as e,a1 as a,a4 as n}from"./framework-888972eb.js";const s={},o=n(`<h1 id="reactcli" tabindex="-1"><a class="header-anchor" href="#reactcli" aria-hidden="true">#</a> ReactCli</h1><h2 id="一、todolist案例相关知识点" tabindex="-1"><a class="header-anchor" href="#一、todolist案例相关知识点" aria-hidden="true">#</a> 一、todoList案例相关知识点</h2><pre><code>	1.拆分组件、实现静态组件，注意：className、style的写法
...
</code></pre><p>一般组件身上没有history属性,需要经过withRouter()函数加工，将一般组件变为路由组件。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import {withRouter} from &#39;react-router-dom&#39;
class MyComponent {
	render(){}
	//.....
}
...
</code></pre>`,32),r=[o];function p(i,c){return e(),a("div",null,r)}const l=t(s,[["render",p],["__file","ReactCli.html.vue"]]);export{l as default};
