import{_ as t,a0 as e,a1 as a,a4 as n}from"./framework-16947f8e.js";const s={},o=n(`<h1 id="reactcli" tabindex="-1"><a class="header-anchor" href="#reactcli" aria-hidden="true">#</a> ReactCli</h1><h2 id="一、todolist案例相关知识点" tabindex="-1"><a class="header-anchor" href="#一、todolist案例相关知识点" aria-hidden="true">#</a> 一、todoList案例相关知识点</h2><pre><code>1.拆分组件、实现静态组件，注意：className、style的写法
