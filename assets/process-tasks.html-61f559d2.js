import{_ as n,a0 as s,a1 as a,a4 as t}from"./framework-16947f8e.js";const p={},e=t(`<h1 id="任务队列的中断和恢复" tabindex="-1"><a class="header-anchor" href="#任务队列的中断和恢复" aria-hidden="true">#</a> 任务队列的中断和恢复</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 依次顺序执行一系列任务
