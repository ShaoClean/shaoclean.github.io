import{$ as n,a0 as s,a1 as a,a4 as p}from"./framework-19a42cda.js";const t={},e=p(`<h1 id="前端工程化配置文件" tabindex="-1"><a class="header-anchor" href="#前端工程化配置文件" aria-hidden="true">#</a> 前端工程化配置文件</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//webpack.config.js</span>
